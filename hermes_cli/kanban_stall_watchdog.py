...
# ``dispatch_once`` for silent-skip cases that never even reach the
# claim step — unknown_profile, unassigned, per_profile_capped,
# assign_failed. Without this trigger the ticket sits in ``ready``
# forever with zero visible signal.
_TRIGGER_KINDS = ("claim_rejected", "dependency_wait", "dispatch_skipped")
