...
DEFAULT_CONTEXT_LENGTHS = {
    ...
    # zero errors on api.z.ai/api/coding/paas/v4).  GLM-5.3 (Z.ai docs,
    # 2026-08) confirms 1M context / 128K max output with always-on
    # reasoning (thinking.type "disabled" is rejected server-side).
