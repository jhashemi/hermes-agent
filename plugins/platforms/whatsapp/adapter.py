...
class WhatsAppAdapter(WhatsAppBehaviorMixin, BasePlatformAdapter):
    ...
    async def _build_message_event(self, data: Dict[str, Any]) -> Optional[MessageEvent]:
        ...
        try:
            ...
            # generic text-injection branch. WhatsApp bridge has already
            # downloaded the document to a local path on disk; we read that
            # path's bytes and feed them to install_skill_file().
