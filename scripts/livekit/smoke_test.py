...
async def smoke():
    ...
    print()
    print("Deferred (contract mismatch with ADR-008 bridge):")
    print("  • /transcribe round-trip (agent sends raw audio bytes;")
    print("    ADR-008 expects {audio_url})")
    print("  • /synthesize round-trip (agent sends {text,voice,room};")
    print("    ADR-008 expects {text,voice_uuid,agent_id})")
